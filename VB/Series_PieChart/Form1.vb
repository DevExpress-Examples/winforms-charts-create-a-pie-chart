...
Namespace Series_PieChart
    Partial Public Class Form1
        ...
        Handles MyBase.Load
            ...
            myView.ExplodedPointsFilters.Add(New  _
                SeriesPointFilter(SeriesPointKey.Value_1, DataFilterCondition.GreaterThanOrEqual, 9))
            myView.ExplodedPointsFilters.Add(New  _
                SeriesPointFilter(SeriesPointKey.Argument, DataFilterCondition.NotEqual, "Others"))
